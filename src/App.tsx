  ...
  return (
    <div className="max-w-3xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
      ...
      <section className="mb-6">
        ...
        <p>Elles sont conservées pendant [durée] et sont destinées aux services [préciser lesquels] de Mon P'tit Poulet.</p>
        <p>Conformément à la loi « informatique et libertés », vous pouvez exercer votre droit d'accès aux données vous concernant et les faire rectifier en contactant : [contact].</p>
      </section>
